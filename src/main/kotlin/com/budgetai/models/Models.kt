...
object Users : IntIdTable("users") {
    ...
    val createdAt = timestamp("created_at").defaultExpression(org.jetbrains.exposed.sql.statements.helpers.CurrentTimestamp())
}
...
object AiInsights : IntIdTable("ai_insights") {
    ...
    val metadata = json<JsonElement>("metadata").nullable()
    val createdAt = timestamp("created_at").defaultExpression(org.jetbrains.exposed.sql.statements.helpers.CurrentTimestamp())
}