...
fun Application.configureRoutes(config: ApplicationConfig, database: Database? = null) {
    ...
    routing {
        ...
        reportRoutes(userService, budgetItemService, budgetService, categoryService, savingsGoalService, aiInsightService, config)
        settingsRoutes(userService)

        // API routes
        userRoutes(userService)
        budgetRoutes(budgetService, budgetItemService, categoryService, s3Handler)
